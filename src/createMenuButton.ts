import { OriginalPlayer, type PlaybackState } from './index.d';
...
export const createMenuButton = (
	...
	case 'resumePlayback':
		...
		player.on('lastTimeTrigger', (data: PlaybackState) => {
			progressBar.style.width = `${data.percentage > 99 ? 100 : data.percentage}%`;
		});
